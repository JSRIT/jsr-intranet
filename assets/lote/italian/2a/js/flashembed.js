...
function insertSwf(swfFile, width, height, quality, bgcol, mode){  
      
	  var wmode;
	  var wmode_emb;
	  if (mode = 'trans'){
		  wmode = ' <param name="WMODE" value="transparent"> ';
		  wmode_emb = ' wmode="transparent" ';
	  }
	...
	document.write('<param name="movie" value="'+swfFile+'">\n');
      ...
      document.write('<embed src="' + swfFile + '"' + wmode_emb + 'bgcolor="'+bgcol+'" quality="'+quality+'" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="'+width+'" height="'+height+'" allowScriptAccess="always">\n</embed></object>\n'); 
}

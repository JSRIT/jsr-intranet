...
function useFsCommand()
{
	...
	if(navigator.appName.indexOf("Microsoft") != -1){
		var theDiv = document.createElement("div");
		theDiv.id  = "afdsads";
		theDiv.innerHTML = "<embed src='../../../../../../italian/1a/before/js/gateway.swf' FlashVars='name=_level0.useFsCommand&value=true' width='0' height='0' type='application/x-shockwave-flash'></embed>";
		document.body.appendChild(theDiv)
	} else {	
		var theDiv = document.createElement("div");
		theDiv.id  = "afdsads";
		theDiv.innerHTML = "<embed src='../../../../../../italian/1a/before/js/gateway.swf' FlashVars='name=_level0.useFsCommand&value=false' width='0' height='0' type='application/x-shockwave-flash'></embed>";
		document.body.appendChild(theDiv)
	}	
}
...
function setFlashVariable(name, value)
{
	...
	if(navigator.appName.indexOf("Microsoft") != -1){
		...
		var divinfo          = "<embed src='../../../../../../italian/1a/before/js/gateway.swf?r=" + new Date().getTime() + "' FlashVars='name=" + name + 

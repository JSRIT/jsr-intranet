...
function insertSwf(swfFile, width, height, quality, bgcol){  
	...
	document.write('<param name="movie" value="'+swfFile+'">\n');
      ...
      document.write('<embed src="../../../../../../../../italian/3b/content/shared/risorse/js/' + swfFile + '" bgcolor="'+bgcol+'" quality="'+quality+'" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="'+width+'" height="'+height+'" allowScriptAccess="always">\n</embed></object>\n'); 
}

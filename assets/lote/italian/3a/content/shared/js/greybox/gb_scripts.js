...
var _1d={width:400,height:300,type:"image",fullscreen:false,center_win:true,caption:_1a,callback_fn:_1c};
...
var _47={caption:_42,height:_44||500,width:_45||600,fullscreen:false,callback_fn:_46};
...
GB_showCenter=function(_49,url,_4b,_4c,_4d){
	if(window.screen) {
		if (screen.availWidth == 800) {
			var globalWidth = screen.availWidth - 300;
			var globalHeight = screen.availHeight - 250;
		} else {
			var globalWidth = screen.availWidth - 450;
			var globalHeight = screen.availHeight - 320;
		}
	}
	
var _4e={caption:_49,center_win:true,height:_4b||globalHeight,width:_4c||globalWidth,fullscreen:false,callback_fn:_4d};
...
AJS.setWidth(this.header,this.width+3);
AJS.setWidth(this.iframe,this.width);
AJS.setHeight(this.iframe,this.height);
},setWindowPosition:function(){

	...
	$('a').each(function(){ // go through all anchors in the page
		...
		if (oRegExp.test(strAttVal)){
			...
			$(this).click(function(){ // add click handler
				...
				var oWin = window.open($(this).attr('href'), 'popup' + dtNow.getTime(), strWSize + ",resizable=" + strResizable + ",scrollbars=" + strScrollbars);
				if (oWin) {
...
$(document).ready(function(){
	...
	popup_init('class','popup_minisite','');
	popup_init('class','popup_resources','');
